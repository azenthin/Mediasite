      ...
      <div className="max-w-md w-full space-y-8 p-8 rounded-lg shadow-lg border" style={{ backgroundColor: '#1a1a1a', borderColor: '#404040' }}>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4">
            ...
            <div>
              <label htmlFor="username" className="block text-sm font-medium" style={{ color: '#d1d5db' }}>
                Username
              </label>
              <input
                id="username"
            ...
            <div>
              <label htmlFor="displayName" className="block text-sm font-medium" style={{ color: '#d1d5db' }}>
        ...
        <div className="text-center">
          <p className="text-sm" style={{ color: '#9ca3af' }}>
            ...
            <a href="/auth/signin" className="font-medium" style={{ color: '#f87171' }}>
              Sign in
            </a>
          </p>
        </div>
