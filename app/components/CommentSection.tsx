...
const CommentSection: React.FC<CommentSectionProps> = ({
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        <>
          {/* Comment Section - Full height overlay like YouTube Shorts */}
          <motion.div
            initial={{ x: '100%' }}
            animate={{ x: 0 }}
            exit={{ x: '100%' }}
            transition={{ type: 'spring', damping: 30, stiffness: 300 }}
            className="fixed right-0 top-0 h-full w-full max-w-sm bg-black z-50 flex flex-col"
          >
            {/* Header - Exact YouTube style */}
            ...
            {/* Comments List - Exact YouTube style */}
            ...
            {/* Comment Form - Exact YouTube style */}
            {!replyingTo && (
