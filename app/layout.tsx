...
export const metadata = {
  ...
  // Temporarily disabled CSP meta tag to fix Vercel scripts
  // other: {
  //   'Content-Security-Policy': "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://va.vercel-scripts.com https://vercel.live https://vercel.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com data:; img-src 'self' data: https://* https://picsum.photos https://placehold.co; media-src 'self' https://*; connect-src 'self' https://va.vercel-scripts.com https://vercel.live https://vercel.com; object-src 'none'; base-uri 'self'",
  // },
}
